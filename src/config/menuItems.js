  ...
  return [
    {
      ...
      leftIcon: <HomeIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/News',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'News' }),
      leftIcon: <NewspaperIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Cardings',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Cardings' }),
      leftIcon: <ScoreboardIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Gallery',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Gallery' }),
      leftIcon: <CollectionsIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Constitution',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Constitution' }),
      leftIcon: <ArticleIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Directions',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Directions' }),
      leftIcon: <NavigationIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Popia',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Popia' }),
      leftIcon: <InfoIcon style={{ fontSize: '2.5rem' }} />,
    },
    {
      value: '/Contact',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'Contact' }),
      leftIcon: <PhoneIcon style={{ fontSize: '2.5rem' }} />,
    },
    // {
